...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  const [isReocording, setIsRecording] = useState(false)
  ...
  function handleStartRecording() {
    ...
    speechRecognition.continuous = true // parar a gravação manualmente
    speechRecognition.maxAlternatives = 1 // uma alternativa caso não entenda muito bem a fala
    speechRecognition.interimResults = true // traga o resultado enquanto for falando
    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Close className="absolute right-0 top-0 bg-slate-800 p-1.5 text-slate-400 hover:text-slate-100">
          ...
          >
            <div className="flex flex-1 flex-col ga-3 p-5">
